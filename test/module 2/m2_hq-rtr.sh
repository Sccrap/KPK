...
# Задание 7: nftables DNAT (port forwarding)
# Туннель GRE + OSPF (FRR)
# ============================================================
set -e

echo "[*] === HQ-RTR: MODULE 2 ==="
...
# ============================================================
# ЗАДАНИЕ 7: СТАТИЧЕСКАЯ МАРШРУТИЗАЦИЯ + NAT/DNAT
# ============================================================
echo "[*] [7] Настраиваем nftables (NAT + DNAT)..."

# Читаем текущий конфиг и добавляем таблицу nat (если нет)
...
# ============================================================
# ТУННЕЛЬ GRE (Вариант 1 — через /etc/net/ifaces)
# ============================================================
...
ping -c 2 10.5.5.2 || echo "[!] Туннель ещё не поднят — жди BR-RTR"
...
echo "[+] === HQ-RTR MODULE 2: Завершено ==="
