#!/bin/bash
###############################################################################
# m3_br-rtr.sh — BR-RTR configuration (Module 3, ALT Linux)
...
echo ""
echo "=== BR-RTR (Module 3) configured ==="
echo "Test rsyslog: logger -p warn 'TEST from br-rtr'"
